...
SET
    ...
    region = NULL,      -- Remove region data completely
    ...
    firstname = mask_first_name(firstname),      -- Replace first name with User_<hash>
    middlename = mask_middle_name(middlename),      -- Replace middle name with User_<hash>
    lastname = mask_last_name(lastname),      -- Replace last name with User_<hash>
    previous_employer = NULL,      -- Remove previous employer data completely
    previous_employer_tin = NULL;      -- Remove previous employer TIN completely
